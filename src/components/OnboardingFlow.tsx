        ...
        <div className="fixed inset-0 z-50 flex flex-col">
          ...
          <div className="relative z-10 px-8 pb-10 space-y-3">
            <motion.button
              ...
              onClick={next}
              className="w-full py-4 rounded-full bg-white text-foreground font-semibold text-base shadow-lg"
            >
              Take a quick tour
            </motion.button>
            <motion.button
              ...
              className="w-full py-4 rounded-full bg-foreground text-white font-semibold text-base flex items-center justify-center gap-3"
            >
