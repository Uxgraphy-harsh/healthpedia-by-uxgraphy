        ...
        <>
          ...
          >
            ...
            <div className="relative flex items-center justify-between px-5 py-2">
              <button
                onClick={onClose}
                className="text-[15px] font-medium text-[#60A5FA]"
              >
                Cancel
              </button>
              <h2 className="absolute left-1/2 -translate-x-1/2 text-[16px] font-bold whitespace-nowrap">Add a Medical Record</h2>
